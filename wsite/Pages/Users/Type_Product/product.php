...
<div class="container">
    <?php
    $select_pro = $database->prepare("select * from type_product where id_car='$idcar'");
    ...
    if($select_pro->rowCount()==0){
     ...
     <a href="../available.php?id=' . $fetch_product['id'].'&id_car='.$idcar.'"><div class="card bg-dark text-white card-type-car">
        <img src="../images/mar/' . $fetch_product['image'].'" class="card-img" alt="..." height="270px">
        <div class="card-img-overlay text-center card-text ">
          <div class="tt">
            <h5 class="">'.$fetch_product['nametype'].'</h5>
          </div>
        </div>
      </div></a>
    </div>';
